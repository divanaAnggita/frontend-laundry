...
import TransaksiList from "../views/component/TransaksiList"
    ...
    render() {
        return (
            <div className="content">
                ...
                {/* modal edit status */}
                <Modal isOpen={this.state.modalStatus} toggle={this.toggleStatus}>
                        ...
                        <div className="modal-body">
                            <form onSubmit={ev => this.saveStatus(ev, this.state.id_transaksi)}>
                                ...
                                <div className="form-group">
                                    <select name="status" id="status" className="form-control bg-dark"
                                ...
                                Status Bayar
                                <div className="form-group">
                                    <select name="bayar" id="bayar" className="form-control bg-dark"
                    ...
                    < div className="modal-content">
                        ...
                        <div className="modal-body">
                            <form onSubmit={(e) => this.saveTransaksi(e)}>
                                Nama Member
                                <select className="form-control mb-2 bg-dark"
                                ...
                                Tanggal
                                <input type="date" className="form-control mb-1 bg-dark"
                                ...
                                Jumlah (Qty)
                                <input type="number" className="form-control mb-2 bg-dark"
